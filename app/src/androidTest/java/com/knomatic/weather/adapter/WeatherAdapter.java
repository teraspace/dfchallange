...
public class WeatherAdapter extends BaseAdapter {
    ...
    public WeatherAdapter( WeatherActivity activity,String strCurrentWeather,String icon, ArrayList<HashMap<String, String>> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            dataHolder.txtDateTime.setText("Time : " + Util.getTime(dateStr));
            ...
            dataHolder.txtReal.setText("Prep Probability : " +  getWeatherValue(lstWeather, "temperature"));
            dataHolder.txtFeel.setText("Prep Probability : " +  getWeatherValue(lstWeather, "apparentTemperature"));
            try {
